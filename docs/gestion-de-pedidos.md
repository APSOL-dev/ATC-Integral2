...
- **Sincronización de Stock en Tiempo Real al Editar (Pedidos 0.0):** Al ingresar a editar un pedido en estado `0.0` (o borrador), el sistema cruza en tiempo real cada artículo cargado con la información actualizada del catálogo de la base de datos (`productos`), mostrando la existencia actual disponible en lugar de valores `0` o estáticos archivados.
  - *Verificado por:* [editStock.test.jsx](file:///c:/Users/Renata%20Morano/OneDrive/Documentos/Antigravity/COPIA%20ATC%20Migraci%C3%B3n/client/src/pages/pedidos/editStock.test.jsx)
- **Ingreso Manual y Edición In-Place en Renglón:** Al editar un pedido (`EditPedidoModal.jsx`), la cantidad se edita mediante un campo numérico `<input type="number">` o botones `-`/`+` directo en la fila. Las modificaciones efectuadas en el propio renglón actualizan el valor `in-place` manteniendo la fila en su posición estática original sin reordenarse.
  - *Verificado por:* [editPedidoStaticRows.test.jsx](file:///c:/Users/Renata%20Morano/OneDrive/Documentos/Antigravity/ATC%20Migraci%C3%B3n/client/src/pages/pedidos/editPedidoStaticRows.test.jsx)
- **Posicionamiento al Inicio desde Buscador:** Al buscar y agregar un producto (sea nuevo o uno existente para incrementarle cantidad desde el buscador), el producto se sitúa al principio de la tabla (posición 0).
  - *Verificado por:* [editPedidoStaticRows.test.jsx](file:///c:/Users/Renata%20Morano/OneDrive/Documentos/Antigravity/ATC%20Migraci%C3%B3n/client/src/pages/pedidos/editPedidoStaticRows.test.jsx)
...
- **Hidratación Infalible de Detalles al Recargar (`GET /api/pedidos/:id` y `details-batch`):** Al recargar la pantalla en la ruta de un pedido específico (`/pedidos/:id`), `PedidoDetail.jsx` dispara la hidratación de detalles mediante `/details-batch` y el endpoint individual `GET /api/pedidos/:id`. Si el pedido en pantalla es un pedido derivado/modificado que no contiene renglones propios grabados pero posee `Nro_PedidoReferencia`, el backend resuelve automáticamente los renglones del pedido original referenciado como fallback seguro, previniendo visualizaciones en `$0`.
  - *Verificado por:* [pedidos_id.test.js](file:///c:/Users/Renata%20Morano/OneDrive/Documentos/Antigravity/ATC%20Migraci%C3%B3n/server/test/pedidos_id.test.js) y [PedidoDetailReload.test.jsx](file:///c:/Users/Renata%20Morano/OneDrive/Documentos/Antigravity/ATC%20Migraci%C3%B3n/client/src/pages/pedidos/PedidoDetailReload.test.jsx)

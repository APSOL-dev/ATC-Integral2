...
- **Precisión Decimal de hasta 4 Decimales:** El campo de porcentaje en la administración de descuentos por marca admite números con hasta 4 decimales (ej. `15.2534%`, `12.8750%`). Las operaciones aritméticas del motor de cálculo de pedidos conservan la precisión exacta tanto en el desglose de importes como en la persistencia hacia las bases de datos (Supabase y SQL Server).
...
- **Porcentajes con Decimales Arbitrarios (hasta 4 dígitos):** Se admite el ingreso con punto o coma decimal (`15.2534` o `15,2534`). El cálculo en cascada aplica el factor fraccionario con total precisión aritmética de punto flotante sin redondeos prematuros.

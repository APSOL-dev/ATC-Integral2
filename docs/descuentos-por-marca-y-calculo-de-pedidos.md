...
- **Cálculo de Totales Desglosado Acumulativo:**
  - `Subtotal Bruto`: suma de `Precio * Cantidad` de todos los ítems del pedido.
  - `Descuento por Marca`: suma de los importes descontados en artículos promocionados por marca.
  - `Monto Desc. General (19%)`: 19% aplicado sobre el 100% del `Subtotal Bruto`.
  - `Total Neto Final`: `Subtotal Bruto - Descuento por Marca - Monto Desc. General (19%)`.
...
- **Productos con Descuento por Marca y Descuento General:** Ambos descuentos se acumulan. Por ejemplo, en un pedido de $20.000 bruto ($10.000 Netcolor con 25% desc. marca + $10.000 marca genérica), el Descuento de Marca es $2.500 y el Descuento General es $3.800 (19% de $20.000). El Total Neto Final es $13.700.
